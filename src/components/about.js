          ...
          <div className="container mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg leading-relaxed text-gray-600">
                At <span className="font-semibold text-blue-600">Your Smile Dental</span>, we are dedicated to providing top-quality dental care in a comfortable and welcoming environment. Our team of skilled professionals uses the latest technology and techniques to ensure every patient leaves with a healthy, radiant smile.
              </p>
            </div>
            <div>
              <img
                ...
                alt="Dental Care"
                className="rounded-lg shadow-md w-full h-auto rounded-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
              />
            </div>
          </div>
        </section>
